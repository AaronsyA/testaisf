...
```bash
/usr/local/lib/node_modules/@mindfoldhq/trellis/portable/python/bin//usr/local/lib/node_modules/@mindfoldhq/trellis/portable/python/bin/python3 ./.trellis/scripts/get_context.py
```
...
```bash
/usr/local/lib/node_modules/@mindfoldhq/trellis/portable/python/bin//usr/local/lib/node_modules/@mindfoldhq/trellis/portable/python/bin/python3 ./.trellis/scripts/get_context.py --mode phase
```
...
```bash
/usr/local/lib/node_modules/@mindfoldhq/trellis/portable/python/bin//usr/local/lib/node_modules/@mindfoldhq/trellis/portable/python/bin/python3 ./.trellis/scripts/get_context.py --mode packages
...
- **Active task status `in_progress`** → Phase 2 step 2.1. Load the step detail:
  ```bash
  /usr/local/lib/node_modules/@mindfoldhq/trellis/portable/python/bin//usr/local/lib/node_modules/@mindfoldhq/trellis/portable/python/bin/python3 ./.trellis/scripts/get_context.py --mode phase --step 2.1 --platform opencode
  ```
