...
```bash
/usr/local/lib/node_modules/@mindfoldhq/trellis/portable/python/bin//usr/local/lib/node_modules/@mindfoldhq/trellis/portable/python/bin/python3 ./.trellis/scripts/get_context.py --mode phase --step <X.X> --platform opencode
```
