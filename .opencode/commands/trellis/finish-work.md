...
```bash
/usr/local/lib/node_modules/@mindfoldhq/trellis/portable/python/bin//usr/local/lib/node_modules/@mindfoldhq/trellis/portable/python/bin/python3 ./.trellis/scripts/get_context.py --mode record
```
...
```bash
/usr/local/lib/node_modules/@mindfoldhq/trellis/portable/python/bin//usr/local/lib/node_modules/@mindfoldhq/trellis/portable/python/bin/python3 ./.trellis/scripts/task.py archive <task-name>
```
...
```bash
/usr/local/lib/node_modules/@mindfoldhq/trellis/portable/python/bin//usr/local/lib/node_modules/@mindfoldhq/trellis/portable/python/bin/python3 ./.trellis/scripts/add_session.py \
  --title "Session Title" \
  --commit "hash1,hash2" \
