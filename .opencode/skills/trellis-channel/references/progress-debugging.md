...
trellis channel messages <channel> --raw --kind progress --last 80 \
  | /usr/local/lib/node_modules/@mindfoldhq/trellis/portable/python/bin/python3 -c 'import json,sys; [print((json.loads(l).get("detail") or {}).get("text_delta",""), end="") for l in sys.stdin if l.strip()]'
```
