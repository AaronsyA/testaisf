...
hooks:
  after_create:
    - "/usr/local/lib/node_modules/@mindfoldhq/trellis/portable/python/bin/python3 .trellis/scripts/hooks/my_sync.py create"
  after_start:
    - "/usr/local/lib/node_modules/@mindfoldhq/trellis/portable/python/bin/python3 .trellis/scripts/hooks/my_sync.py start"
  after_finish:
    - "/usr/local/lib/node_modules/@mindfoldhq/trellis/portable/python/bin/python3 .trellis/scripts/hooks/my_sync.py finish"
  after_archive:
    - "/usr/local/lib/node_modules/@mindfoldhq/trellis/portable/python/bin/python3 .trellis/scripts/hooks/my_sync.py archive"
```
...
1. Confirm the current task with `/usr/local/lib/node_modules/@mindfoldhq/trellis/portable/python/bin/python3 ./.trellis/scripts/task.py current --source`.
