...
Usage (called automatically by task.py hooks):
    /usr/local/lib/node_modules/@mindfoldhq/trellis/portable/python/bin/python3 .trellis/scripts/hooks/linear_sync.py create
    /usr/local/lib/node_modules/@mindfoldhq/trellis/portable/python/bin/python3 .trellis/scripts/hooks/linear_sync.py start
    /usr/local/lib/node_modules/@mindfoldhq/trellis/portable/python/bin/python3 .trellis/scripts/hooks/linear_sync.py archive

Manual usage:
    TASK_JSON_PATH=.trellis/tasks/<name>/task.json /usr/local/lib/node_modules/@mindfoldhq/trellis/portable/python/bin/python3 .trellis/scripts/hooks/linear_sync.py sync
