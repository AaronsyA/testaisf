...
Usage:
    /usr/local/lib/node_modules/@mindfoldhq/trellis/portable/python/bin/python3 add_session.py --title "Title" --commit "hash" --summary "Summary" [--package cli]
    /usr/local/lib/node_modules/@mindfoldhq/trellis/portable/python/bin/python3 add_session.py --title "Title" --branch "feat/my-branch"

    # Pipe detailed content via stdin (use --stdin to opt in):
    cat << 'EOF' | /usr/local/lib/node_modules/@mindfoldhq/trellis/portable/python/bin/python3 add_session.py --stdin --title "Title" --summary "Summary"
    <session content here>
    EOF

    # Structured content (repeatable; a section with no bullets is omitted):
    /usr/local/lib/node_modules/@mindfoldhq/trellis/portable/python/bin/python3 add_session.py --title "Title" --change "Did X" --test "Ran Y" --next-step "Do Z"
