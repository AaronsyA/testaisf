...
def ensure_developer(repo_root: Path | None = None) -> None:
    ...
    if not check_developer(repo_root):
        ...
        print(f"Run: /usr/local/lib/node_modules/@mindfoldhq/trellis/portable/python/bin/python3 ./{DIR_WORKFLOW}/scripts/init_developer.py <your-name>", file=sys.stderr)
        sys.exit(1)
