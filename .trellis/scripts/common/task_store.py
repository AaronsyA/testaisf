...
_SEED_EXAMPLE = (
    ...
    "Run `/usr/local/lib/node_modules/@mindfoldhq/trellis/portable/python/bin/python3 .trellis/scripts/get_context.py --mode packages` to list available specs. "
...
def cmd_set_branch(args: argparse.Namespace) -> int:
    ...
    if not branch:
        ...
        print("Usage: /usr/local/lib/node_modules/@mindfoldhq/trellis/portable/python/bin/python3 task.py set-branch <task-dir> <branch-name>")
        return 1
...
def cmd_set_base_branch(args: argparse.Namespace) -> int:
    ...
    if not base_branch:
        print(colored("Error: Missing arguments", Colors.RED))
        print("Usage: /usr/local/lib/node_modules/@mindfoldhq/trellis/portable/python/bin/python3 task.py set-base-branch <task-dir> <base-branch>")
        print("Example: /usr/local/lib/node_modules/@mindfoldhq/trellis/portable/python/bin/python3 task.py set-base-branch <dir> develop")
        print()
...
def cmd_set_scope(args: argparse.Namespace) -> int:
    ...
    if not scope:
        print(colored("Error: Missing arguments", Colors.RED))
        print("Usage: /usr/local/lib/node_modules/@mindfoldhq/trellis/portable/python/bin/python3 task.py set-scope <task-dir> <scope>")
        return 1
...
def cmd_set_meta(args: argparse.Namespace) -> int:
    ...
    if not key:
        print(colored("Error: Missing arguments", Colors.RED))
        print("Usage: /usr/local/lib/node_modules/@mindfoldhq/trellis/portable/python/bin/python3 task.py set-meta <task-dir> <key> <value>")
        return 1
